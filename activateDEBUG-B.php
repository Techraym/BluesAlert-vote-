...
if(mysql_affected_rows($conn)>0){
	$p ="<h2>Hartelijk dank, uw top 5 is bevestigd !</h2><div>";
	$q2 = "SELECT id, name FROM users WHERE hash = '$v'";
	$r2 = mysql_query($q2,$conn) or DIE ("ongeldige query voor user");
	...
	$r3 = mysql_query($q3,$conn) OR DIE (mysql_error());
	...
	$p = "<h2 class='error'>Uw stemlijst is al bevestigd of er is iets mis gegaan met uw bevestiging, controleer uw mail en probeer het opnieiuw</h2>";
}
?>
<!DOCTYPE html>
<html lang="nl">
  <head>
    <meta charset="utf-8">
     <meta property="og:url"           content="http://192.8.7.6.nl/bluesalert/index.php" />
    <meta property="og:type"          content="BluesAlert " />
    <meta property="og:title"         content="Nederlandse Blues Top 100 Allertijden" />
    <meta property="og:description"   content="Stem voor uw eigen top 5 nummers van Nederlandse Blues bands/artiesten" />
    <meta property="og:image"         content="http://192.8.7.6.nl/bluesalert/logo.jpg" />
...
?>
	...
	<div class="fb-share-button" data-href="http://hielemedia.nl/bluesalert" data-layout="button"></div>
	</body>
</html>
